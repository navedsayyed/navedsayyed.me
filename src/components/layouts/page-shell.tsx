...
export const HatchDivider = () => (
  <div className="-mx-8 h-8 border-y border-y-(--pattern-fg) bg-[repeating-linear-gradient(315deg,var(--pattern-fg)_0,var(--pattern-fg)_1px,transparent_0,transparent_50%)] bg-size-[10px_10px] bg-fixed" />
);
